...
thirdMoveOnM.onclick = function() {
	...
	fetch("http://localhost:8080/grad", {
		...
		response.json().then(function (data) {
			...
			var wrapper = document.querySelector("#fileBodyM");
			var schedule1button = document.querySelector("#fileLabel1M");
			var schedule2button = document.querySelector("#fileLabel2M");
			var schedule3button = document.querySelector("#fileLabel3M");
